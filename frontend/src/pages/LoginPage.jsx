...
import { Coins, Heart, Mail, Lock, Loader2, LogIn } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-violet-50 font-sans flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-[320px] bg-white rounded-sm shadow-[0_25px_60px_rgba(0,0,0,0.15)] border border-violet-100 px-8 py-14">
        ...
        <form onSubmit={handleLogin} className="flex flex-col space-y-6">
          ...
          <div className="text-center pt-2">
            <p className="text-sm text-slate-500 font-bold uppercase tracking-widest font-mono">
              New User?{' '}
              <Link to="/register" className="text-violet-600 font-black hover:underline underline-offset-4 transition-all">
                Register
              </Link>
            </p>
          </div>
